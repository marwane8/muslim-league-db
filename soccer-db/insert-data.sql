...
INSERT INTO games (game_id, season_id, team1_id, team2_id, location_id, date, start_time, playoff, played)
SELECT game_id, season_id, team1_id, team2_id, location_id, date, start_time, playoff, played
FROM games_temp;
